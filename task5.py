...
i = int(input("Введите номер вагона, начиная с головы состава: "))
j = int(input("Введите номер вагона, в котором оказался Витя: "))
if (i == j):
    print("Невозможно определить без дополнительной информации")
else:
    print(j + i - 1)
